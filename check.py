...
def get_time(driver, period):
    ...
    try:
        ...
        x = WebDriverWait(driver, 2).until(lambda x: x.find_element_by_xpath('//*[@id="ctl00_ContentPlaceHolder1_grdIOrequest_ctl00_ctl03_ctl01_PageSizeComboBox_DropDown"]/div/ul/li[3]'))
        sleep(1)
